...
CREATE TABLE IF NOT EXISTS qa_data (
  ...
  remarks TEXT NULL,
  original_sprint_id INT NULL,
  UNIQUE KEY uk_qa_data_change_sprint (change_id, new_sprint_id),
  KEY idx_qa_data_new_sprint_id (new_sprint_id),
  KEY idx_qa_data_original_sprint_id (original_sprint_id),
  ...
  CONSTRAINT fk_qa_data_original_sprint FOREIGN KEY (original_sprint_id) REFERENCES new_sprint(id) ON DELETE SET NULL ON UPDATE CASCADE,
